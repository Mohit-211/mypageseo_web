    ...
    <div className="container mx-auto px-4 lg:px-8 text-center">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <p className="text-accent-foreground/85 text-lg leading-relaxed max-w-2xl mx-auto">
          Choose a strategy aligned with your growth objectives. Let's build a
          structured plan that delivers measurable local visibility and real
          business results.
        </p>
