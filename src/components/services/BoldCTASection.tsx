    ...
    <div className="container mx-auto px-4 lg:px-8 text-center">
      <div className="max-w-3xl mx-auto space-y-6">
        <h2 className="text-3xl lg:text-4xl xl:text-5xl font-heading font-bold text-accent-foreground leading-tight">
          Take Control of Your Local Market — Starting Today
        </h2>

        <p className="text-accent-foreground/85 text-lg leading-relaxed max-w-2xl mx-auto">
          Every day without a structured local SEO strategy is a day your
          competitors capture the calls, leads, and customers that should be
          yours. Let's build the visibility and authority your business
          deserves.
        </p>
